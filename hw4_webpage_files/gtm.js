...
return null},Ff=!1;if(I.querySelectorAll)try{var Gf=I.querySelectorAll(":root");Gf&&1==Gf.length&&Gf[0]==I.documentElement&&(Ff=!0)}catch(a){}var Cf=Ff;var Hd={},T=null,Uf=Math.random();Hd.B="GTM-PLVRLF";Hd.Rb="6o0";Hd.Sd="";var Vf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Wf="www.googletagmanager.com/gtm.js";
var Xf=Wf,Yf=null,Zf=null,$f=null,ag="//www.googletagmanager.com/a?id="+Hd.B+"&cv=102",bg={},cg={},dg=function(){var a=T.sequence||0;T.sequence=a+1;return a};
...
Z.b.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=qn(c,"gtm.click");bo(d)}}(function(b){Z.__cl=b;Z.__cl.g="cl";Z.__cl.h=!0;Z.__cl.priorityOverride=0})(function(b){if(!go("cl")){var c=W("document");We(c,"click",a,!0);ho("cl")}K(b.vtp_gtmOnSuccess)})}();Z.b.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.priorityOverride=0})(function(a){return eo(a.vtp_name,V("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Z.b.awc=["nonGoogleScripts"],function(){var a=!1,b=function(c){if(a)c.vtp_gtmOnSuccess();else{var d=c.vtp_channel||"na",e,f,g;if(c.vtp_group&&0<=c.vtp_group.indexOf(":")){e=c.vtp_group;for(var k=c.vtp_group.split("|"),l=[],m=g=0;m<k.length;m++)if(k[m]){var n=k[m].split(":");if(2==n.length&&n[0]&&n[1]){var r=parseFloat(n[1]);isNaN(r)||(l.push(X(n[0])+":"+r),g+=r)}}f=l.join("|")}else g=c.vtp_orderValue||0,e=(c.vtp_group||"DEFAULT")+":"+g,f=X(c.vtp_group||"DEFAULT")+":"+X(g);var t=c.vtp_testMode?"1":
"0";try{var q=["merchant="+X(c.vtp_merchantId),"ref="+X(c.vtp_orderRef),"amount="+X(g),"parts="+f,"ch="+X(d),"testmode="+t];c.vtp_currency&&q.push("cr="+X(c.vtp_currency));c.vtp_discountCode&&q.push("vc="+X(c.vtp_discountCode));Po("https://www.awin1.com/sread.img?tt=ns&tv=2&"+q.join("&"))}catch(v){}try{var u={};u.orderRef=c.vtp_orderRef;u.amount=g;c.vtp_currency&&(u.currency=c.vtp_currency);u.parts=e;c.vtp_discountCode&&(u.voucher=c.vtp_discountCode);u.channel=d;u.test=t;C.AWIN={Tracking:{Sale:u}};
U("https://www.dwin1.com/"+c.vtp_merchantId+".js",c.vtp_gtmOnSuccess,c.vtp_gtmOnFailure);a=!0}catch(v){K(c.vtp_gtmOnFailure)}}};Z.__awc=b;Z.__awc.g="awc";Z.__awc.h=!0;Z.__awc.priorityOverride=0}();
